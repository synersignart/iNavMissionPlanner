...
class CodeEmitter(object):
    ...
    def __init__(self, folder, ext):
        ...
        mkdir_if_missing(OUTDIR + '/%s' % folder)
...
class Python_Emitter(CodeEmitter):
    ...
    def __init__(self, msgdict):
        ...
        mkdir_if_missing(OUTDIR + '/python/msppg')

        self._copyfile('setup.py', 'python/setup.py')

        self.output = _openw(OUTDIR + '/python/msppg/__init__.py')
...
class CPP_Emitter(CodeEmitter):
    ...
    def __init__(self, msgdict):
        ...
        mkdir_if_missing(OUTDIR + '/cpp/msppg')

        # Create C++ example
        self._copyfile('example.cpp', 'cpp/example.cpp')

        # Create Arduino stuff
        mkdir_if_missing(OUTDIR + '/arduino')
        mkdir_if_missing(OUTDIR + '/arduino/MSPPG')
        mkdir_if_missing(OUTDIR + '/arduino/MSPPG/examples')
        mkdir_if_missing(OUTDIR + '/arduino/MSPPG/examples/imuexample')
        ...
        self.coutput = _openw(OUTDIR + '/cpp/msppg/MSPPG.cpp')
        self.houtput = _openw(OUTDIR + '/cpp/msppg/MSPPG.h')

        self.acoutput = _openw(OUTDIR + '/arduino/MSPPG/MSPPG.cpp')
        self.ahoutput = _openw(OUTDIR + '/arduino/MSPPG/MSPPG.h')
...
class C_Emitter(CodeEmitter):
    ...
    def __init__(self, msgdict):
        ...
        mkdir_if_missing(OUTDIR + '/c/msppg')
        self._copyfile('example.c', 'c/example.c')

        self.type2decl = {'byte': 'char', 'short' : 'short', 'float' : 'float', 'int' : 'int'}

        self.coutput = _openw(OUTDIR + '/c/msppg/msppg.c')
        self.houtput = _openw(OUTDIR + '/c/msppg/msppg.h')
...
class Java_Emitter(CodeEmitter):
    ...
    def __init__(self, msgdict):
        ...
        mkdir_if_missing(OUTDIR + '/java/edu')
        mkdir_if_missing(OUTDIR + '/java/edu/wlu')
